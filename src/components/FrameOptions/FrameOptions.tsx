import { Autocomplete, Box, Button, Card, CardContent, Checkbox, FormControlLabel, Stack, TextField, Tooltip, Typography, type SxProps, type Theme } from "@mui/material";
